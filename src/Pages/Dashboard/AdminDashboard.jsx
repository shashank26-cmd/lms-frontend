            ...
            <div className='min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white'>
                ...
                <div className='mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10'>
                    <div className='flex w-full items-center justify-between'>
                        <h2 className='text-center text-3xl font-semibold'>Course Overview</h2>
                        <button onClick={() => {
                            navigate('/course/create')
                        }}
                        className='w-fit bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded py-2 px-4 font-semibold text-lg '
                        >
                            Create New Course
                        </button>
                    </div>
                                ...
                                myCourses?.map((course,idx) => (
                                    <tr key={course._id}>
                                        ...
                                        <td className='flex items-center gap-4'>
                                            <button
                                            className='bg-green-500 hover:bg-green-600 transition-all duration-200 ease-in-out py-2 px-4 rounded-md font-bold text-xl'
                                            onClick={() => navigate('/course/displaylectures',{state: {...course}})}
                                            >
                                                <BsCollectionPlayFill />
                                            </button>
                                            <button
                                            className='bg-red-500 hover:bg-red-600 transition-all duration-200 ease-in-out py-2 px-4 rounded-md font-bold text-xl'
